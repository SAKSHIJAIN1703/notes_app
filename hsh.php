  ...
  <body onclick='clickFunction()' onload="onLoadRun()" class="main_container">
    ...
    <header class="header-main sticky_header header">
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"><path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-2.3l-.85-.6A4.997 4.997 0 0 1 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.63-.8 3.16-2.15 4.1z"></path>
      </svg> Notes</a>
    ...
    <!-- </div> -->
     ...
     <aside class="sidebar">
       <ul>
         <li class="notes active"><span class="icon_sidebar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-2.3l-.85-.6A4.997 4.997 0 0 1 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.63-.8 3.16-2.15 4.1z"></path></svg></span><span class="icon_text"> Notes </span></li>
         <li class="edit-label" data-toggle="modal" data-target="#exampleModalLong"><span class="icon_sidebar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20.41 4.94l-1.35-1.35c-.78-.78-2.05-.78-2.83 0L13.4 6.41 3 16.82V21h4.18l10.46-10.46 2.77-2.77c.79-.78.79-2.05 0-2.83zm-14 14.12L5 19v-1.36l9.82-9.82 1.41 1.41-9.82 9.83z"></path></svg></span><span class="icon_text"> Edit Labels </span></li>
    ...
    <div class="modal fade modal-edit-label" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        aria-hidden="true" style="padding-left: 0 !important; padding-right: 0!important; padding-left:0! important;">
    ...
    <div class="modal fade confirm_div" id="deleteConfirmation" tabindex="-1" role="dialog" aria-labelledby="deleteConfirmation"
        aria-hidden="true" style="padding-left: 0 !important; padding-right: 0!important; padding-left:0! important;">
        <div class="modal-dialog" role="document">
            <div class="modal-content custom-form"> 
                <div class="modal-body">
    ...
    <script>
      ...
      function showNotes() {
        ...
        $.ajax({ //yha hm requres bhejre hme notes bhejo hs
          ...
          dataType: "json",
          success: function(
            data) { //aur jb notes aajaye toh yhe sb code isme jo hai wo run kardena success function ye bolra
            // hmare paas data aagaya. aab isse hme  note banane aur note div se bante toh hme div banana
            var note = ``;
            ...
            <input type="file" id="file-input" class="noteFile" nt_id="${noteData[0]}" />
          </li>
             <li class="p-1 mr-2" id="color-list-icon" style="position:relative;"><i class="fas fa-palette"></i>
              <div class="color_list p-2">
               <div class="color m-1 color-p" data-color="#ff66b3"></div>
              ...
              $.ajax({
                ...
                success: (data) => {
                  if (data.status = '201') {
                    ...
                    $(this).closest('.single_note').remove(); ///ye bohot shi chiz hai mitr this
                  } else if (data.status = '401') {
                    alert(data.error);
                  } else {
                    alert("Something went wrong!!") ;
            ...
            //  $('.single_note .buttons_div ul li.image-upload').on('click' , function(e){
            //   console.log('helo');
            //  });  
        //      var noteki_id = $(this).attr('nt_id');             
        ...
        //     if($.inArray(imgExt,allowed_extensions) < 0){
        ...
        //   formdata.append("note", noteki_id);   
        //    $.ajax({
        //         type:'POST',
        ...
        //     //     for(i = 1; i <= img_r; i++) {
        //     //       if(i==1){
        //     //         img_data = img_data + `<div class="row" style="margin-bottom: 2px;"><div class="col-12" style="padding-left:0px; padding-right:0px;"><img src="uploads/${image[img_count-i]}" style="width: 100%;height: 150px; border-radius:0 .5rem .5rem 0; "></div></div>`;
        //     //       }else{
        //     //       img_data = img_data +  `<div class="row" style="margin-bottom: 2px;"><div class="col-12" style="padding-left:0px; padding-right:0px;"><img src="uploads/${image[img_count-i]}" style="width: 100%;height: 150px; "></div></div>`;
        //     //       }
        //     //     }
        ...
        //       console.log(image);
        //       console.log('run');
        //               // $(".image").prepend(`<div class="row" style="margin-bottom: 2px;"><div class="col-12" style="padding-left:0px; padding-right:0px;"><img src="uploads/${data.image}" style="width: 100%;height: 150px; "></div></div>`);
        ...
        //     console.log('heheh');     
        //      var  note_id= $(this).closest('li.image-upload').attr('data-noteid');
        //       console.log(note_id);
        //      var file = this.files[0];
        //      var imgname = file.name;
        //      var imgExt = imgname.split('.').pop().toLowerCase();
        ...
        //               let image =(data.image).split(",");
        //               var img_count = image.length;
        //               // var  note_id= $(this).closest('.single_note').attr('data-noteid');
        //               console.log(note_id);
        //             //".image").prepend(`<div class="row" style="margin-bottom: 2px;"><div class="col-12" style="padding-left:0px; padding-right:0px;"><img src="uploads/${data.image}" style="width: 100%;height: 150px; "></div></div>`);
        //             }else if(data.status == 301)
        //             {
