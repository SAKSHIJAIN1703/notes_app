...
?>
  ...
  <body onclick='clickFunction()' onload="showNotes()" class="main_container">
        ...
        $.ajax({ //yha hm requres bhejre hme notes bhejo hs
          ...
          success: function(
            ...
            var formdata = new FormData();
             $('.single_note .buttons_div ul li.image-upload .noteFile').change(function(e){
